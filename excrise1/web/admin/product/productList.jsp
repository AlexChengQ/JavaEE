						...
						<tr>
							...
							<td height="20" bgcolor="#FFFFFF">
								<div align="center" class="STYLE21">
									...
									<a href="${pageContext.request.contextPath }/ProductServlet?op=findCategoryByUpdate&pid=${product.pid}">编辑</a>
								</div>
							</td>
					</tr>
					</c:forEach>
								...
								<tr>
									...
									<td width="49">
										<div align="center">
											...
											<a href="${pageContext.request.contextPath }/ProductServlet?op=findAllProduct&num=${page.previousPageNum}">上一页</a>
												</c:if>
													</span>
										</div>
									</td>
...
<c:if test="${page.currentPageNum < page.totalPageNum}">
	...
	<script type="text/javascript">
		...
		function jump() {
			...
			if (!/^[1-9][0-9]*$/.test(num)) {
				alert("请输入正确的页码");
				window.location.href = "${pageContext.request.contextPath }/ProductServlet?op=findAllProduct&num=1";
				return;
			}
			...
			window.location.href = "${pageContext.request.contextPath }/ProductServlet?op=findAllProduct&num=" + num;
