...
<html>
	...
	<body>
	<form method="post" action="${pageContext.request.contextPath }/ProductServlet?op=updateProduct&pid=${product.pid}&imgurl=${product.imgurl}" enctype="multipart/form-data">
 							...
 							<select name="cid" id="st" onchange="change()">
								<c:forEach items="${categories}" var="category">
									<option value="${category.cid}"
											<c:if test="${category.cid == product.category.cid}">selected = "selected"</c:if>>
									${category.cname}
									</option>
								</c:forEach>
							</select>
				 ...
				 <tr>
					 ...
					 <tr>
						...
						<td width="80%" height="20" bgcolor="d3eaef" class="STYLE6"><div
							...
							<img width="310px" height="158px" src="${pageContext.request.contextPath}${product.imgurl}"/>
