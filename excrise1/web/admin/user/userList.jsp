					...
					<c:forEach items="${page.list }" var="user">
						<tr>
							<td height="20" bgcolor="#FFFFFF">
								<div align="center">
									<input type="checkbox" name="aid" id="aid" value="${user.uid }" />
								</div>
							</td>
						<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
								align="center">
...
<c:if test="${page.currentPageNum != 1}">
											<a href="${pageContext.request.contextPath }/UserServlet?op=findAllUser&num=${page.previousPageNum}">上一页</a>
</c:if>		</span>
										</div>
									</td>
...
<c:if test="${page.currentPageNum < page.totalPageNum}">
	...
	<script type="text/javascript">
		...
		function jump() {
			...
			if (!/^[1-9][0-9]*$/.test(num)) {
				alert("请输入正确的页码");
				window.location.href = "${pageContext.request.contextPath }/UserServlet?op=findAllUser&num=1";
				return;
			}
