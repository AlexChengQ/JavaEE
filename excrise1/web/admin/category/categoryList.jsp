...
<body>
			...
			<td><table width="100%" border="0" cellpadding="0"
					...
					<tr>
						...
						<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
								align="center">
								<span class="STYLE10">皮肤系列号</span>
							</div>
						</td>
						<td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div
								align="center">
								<span class="STYLE10">皮肤系列名</span>
							</div>
						</td>
			...
			<tr>
				<td><table width="100%" border="0" cellpadding="0"
					...
					<tr>
						<td width="4%" height="20" bgcolor="d3eaef" class="STYLE10"><div
								align="center">
							<input type="checkbox" name="checkbox" id="checkbox11" value="${category.cid}" />
						</div>
						</td>
						<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
								align="center">
						...
						<td width="14%" height="20" bgcolor="d3eaef" class="STYLE6"><div
							...
							|<a href="${pageContext.request.contextPath }/CategoryServlet?op=deleteOne&cid=${category.cid}">删除</a>
						</div>
						</td>
					</tr>
					...
					<tr>
						<td width="33%"><div align="left">
								<span class="STYLE22">&nbsp;&nbsp;&nbsp;&nbsp;共有<strong>
									${page.totalRecordNum }</strong> 条记录，当前第<strong>${page.currentPageNum }</strong> 页，共 <strong>${page.totalPageNum }</strong> 页</span>
						</div>
						</td>
						<td width="67%">
								...
								<tr>
									...
									<td width="49">
										<div align="center">
											...
											<a href="${pageContext.request.contextPath }/CategoryServlet?op=findPageCategory&num=${page.previousPageNum}">上一页</a>
												</c:if>
											</span>
										</div>
									</td>
									<td width="49"><span class="STYLE22">
									    <div align="center">
											...
											<a href="${pageContext.request.contextPath }/CategoryServlet?op=findPageCategory&num=${page.nextPageNum}">下一页</a>
												</c:if>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22"><a href="${pageContext.request.contextPath }/CategoryServlet?op=findPageCategory&num=${page.totalPageNum }">尾页</a></span>
												</div>
									</td>
	...
	<script type="text/javascript">
		...
		function jump() {
			...
			if (!/^[1-9][0-9]*$/.test(num)) {
				alert("请输入正确的页码");
				window.location.href = "${pageContext.request.contextPath }/CategoryServlet?op=findPageCategory&num=1";
				return;
			}
