...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
        ...
        <div id="content" class="float_r">
        	...
        	<span><h3  style="width:600px;heigth=40px;background: #EEEEEE; padding: 10px">皮肤列表</h3></span>
        	...
        	<c:forEach items="${requestScope.products }" var="product" varStatus="vs">
        		<div class="${vs.index % 3 != 2?'product_box':'product_box no_margin_right' }">
	                ...
	                <a href="${pageContext.request.contextPath }/ProductServlet?op=findProductById&pid=${product.pid}" class="detail"title="${product.description}"></a>
            	</div>
