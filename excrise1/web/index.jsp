...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
    	<div id="site_title"><h1><a href="http://localhost/${pageContext.request.contextPath }">LOL Skin Mall</a></h1></div>
        <div id="header_right">
        	<p>
        	...
        	<div id="slider-wrapper">
                <div id="slider" class="nivoSlider">
                	<c:forEach items="${productTop }" var="product">
                		<img src="/LOLSkinMall/${product.imgurl }" style="width: 680px;height: 300px" alt="" title="${product.pname }"/>
                	</c:forEach>
                </div>
        	...
        	<c:forEach items="${hotProducts }" var="product" varStatus="vs">
        		<div class="${vs.index % 3 != 2?'product_box':'product_box no_margin_right' }">
	            	...
	            	<a href="${pageContext.request.contextPath }/ProductServlet?op=findProductById&pid=${product.pid}">
	            		<img src="/LOLSkinMall/${product.imgurl }" width="200" height="150" alt="" title="${product.pname }"/>
	            	</a>
    ...
    <div id="templatemo_footer">
    	Copyright (c) 2016 <a href="#">Alex_Cheng Blog</a> | <a href="#">LOL Skin Mall</a>
    </div>
</div>
</div>
	<script type="text/javascript">
